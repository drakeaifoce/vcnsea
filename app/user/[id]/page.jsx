    ...
    <div className=":sm:gap-6 flex flex-col gap-4 px-4 text-black md:gap-8 lg:gap-10">
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex flex-col">
                      ...
                      <h5 className="col-span-1 text-sm font-normal md:text-base lg:text-lg">
                        {experience.title}
                      </h5>
      ...
      <div className="flex flex-col gap-6">
        <div className="flex w-full flex-row items-center gap-9">
          ...
          <Link href={`/user/${params.id}/add-education`} className="text-sm ">
            <Button variant="secondary">+</Button>
          </Link>
        </div>
        <div className="flex flex-col gap-9">
      ...
      <div className="flex flex-col gap-6">
        <div className="flex w-full flex-row items-center gap-9">
          ...
          <Link
            href={`/user/${params.id}/add-certificate`}
            className="text-sm "
          >
            <Button variant="secondary">+</Button>
          </Link>
